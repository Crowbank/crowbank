#!/usr/bin/python
from .petadmin.petadmin import PetAdmin
from .petadmin.env import Environment, clean_html, log, ENVIRONMENT
import argparse
from .petadmin.confirmation import ReportParameters, confirm_all, process_booking
import sys
